...
class CircuitBreakerTest extends AbstractCircuitBreakerTest {
    ...
    void t1() {
        ...
        assertThat(circuitBreaker.getMetrics().getNumberOfBufferedCalls()).isOne(); // 1개 호출 중
        assertThat(circuitBreaker.getMetrics().getNumberOfSuccessfulCalls()).isOne(); // 성공 1개
        assertThat(circuitBreaker.getMetrics().getNumberOfFailedCalls()).isZero(); // 실패 0개
    }
    ...
    void t4() {
        ...
        assertThat(circuitBreaker.getMetrics().getNumberOfSlowSuccessfulCalls()).isZero();
        assertThat(circuitBreaker.getMetrics().getNumberOfSlowFailedCalls()).isZero();
        ...
        assertThat(circuitBreaker.getMetrics().getNumberOfSlowSuccessfulCalls()).isOne();
        assertThat(circuitBreaker.getMetrics().getNumberOfSlowFailedCalls()).isZero();
